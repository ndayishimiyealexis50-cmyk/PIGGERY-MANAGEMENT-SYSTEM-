    ...
    <div style={{
      ...
      >
        ...
        <div key={pageKey} className={pageDir === 'left' ? 'fade-in' : 'fade-in'}>
          {/* REPLACE each PlaceholderPage with your actual imported component */}
          {page === 'home'          && <PlaceholderPage name="Overview / Worker Home" {...commonProps} />}
          {page === 'alerts'        && <PlaceholderPage name="Alerts"           {...commonProps} />}
          {page === 'profitinsight' && <PlaceholderPage name="Profit Insight"   {...commonProps} />}
          {page === 'feedefficiency'&& <PlaceholderPage name="Feed Efficiency"  {...commonProps} />}
          {page === 'pigperformance'&& <PlaceholderPage name="Herd Intelligence" {...commonProps} />}
          {page === 'approvals'     && <PlaceholderPage name="Approvals"        {...commonProps} />}
          {page === 'ai'            && <PlaceholderPage name="AI Advisor"       {...commonProps} />}
          {page === 'bigdata'       && <PlaceholderPage name="Big Data"         {...commonProps} />}
          {page === 'pnl'           && <PlaceholderPage name="P&L Analysis"     {...commonProps} />}
          {page === 'market'        && <PlaceholderPage name="RW Market"        {...commonProps} />}
          {page === 'reproduction'  && <PlaceholderPage name="Reproduction"     {...commonProps} />}
          {page === 'stock'         && <PlaceholderPage name="Stock"            {...commonProps} />}
          {page === 'ledger'        && <PlaceholderPage name="Ledger"           {...commonProps} />}
          {page === 'capital'       && <PlaceholderPage name="Capital"          {...commonProps} />}
          {page === 'pigs'          && <PlaceholderPage name="Pig Records"      {...commonProps} />}
          {page === 'feeding'       && <PlaceholderPage name="Feeding"          {...commonProps} />}
          {page === 'sales'         && <PlaceholderPage name="Sales"            {...commonProps} />}
          {page === 'daylogs'       && <PlaceholderPage name="Daily Logs"       {...commonProps} />}
          {page === 'health'        && <PlaceholderPage name="Health"           {...commonProps} />}
          {page === 'payroll'       && <PlaceholderPage name="Payroll"          {...commonProps} />}
          {page === 'tasks'         && <PlaceholderPage name="Tasks"            {...commonProps} />}
          {page === 'settings'      && <PlaceholderPage name="Settings"         {...commonProps} />}
          {page === 'audit'         && <PlaceholderPage name="Audit Log"        {...commonProps} />}
          {/* Worker-only routes */}
          {page === 'dailyentry'    && <PlaceholderPage name="Daily Entry"      {...commonProps} />}
          {page === 'feedentry'     && <PlaceholderPage name="Feed Entry"       {...commonProps} />}
          {page === 'saleentry'     && <PlaceholderPage name="Sale Entry"       {...commonProps} />}
          {page === 'buyentry'      && <PlaceholderPage name="Buy Entry"        {...commonProps} />}
          {page === 'pigentry'      && <PlaceholderPage name="Pig Registration" {...commonProps} />}
          {page === 'assessment'    && <PlaceholderPage name="Assessment"       {...commonProps} />}
        </div>
      </main>
