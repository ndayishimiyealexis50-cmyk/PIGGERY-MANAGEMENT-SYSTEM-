        ...
        return (
          <div
            ...
            style={{
              ...S.card,
              marginBottom: 12,
              border: i === 0 ? '1.5px solid rgba(245,158,11,.4)' : '1px solid ' + C.border,
            }}
          >
            {/* Header */}
                ...
                <div style={{ width: 80, height: 5, background: C.elevated, borderRadius: 5, overflow: 'hidden' }}>
                  <div
                    style={{
                      height: '100%',
                      width: w.attendance + '%',
                      background: w.attendance >= 80 ? C.accent : w.attendance >= 50 ? C.amber : C.red,
                      borderRadius: 5,
                    }}
                  />
                </div>
                <span style={{ fontSize: 12, fontWeight: 700, color: w.attendance >= 80 ? C.accent : w.attendance >= 50 ? C.amber : C.red, minWidth: 35 }}>
                  {w.attendance}%
                </span>
              </div>
            </div>
